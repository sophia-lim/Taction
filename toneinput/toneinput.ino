...
// Modification made by Sophia the Great and Sebastian the Beast
//boolean toneDetected() {
//  //If tone detected; println frequency return true
//}
...
const int TONE_LOWS[] = {              // Lower bound (in hz) of each tone in the input sequence (E A D G B E)
  75, 100, 130, 180, 230, 310
};
const int TONE_HIGHS[] = {             // Upper bound (in hz) of each tone in the input sequence.
  90, 120, 160, 200, 260, 340
};
...
void setup() {
  ...
  // Set up ADC and audio input. (Analog to Digital Conversion)
...
int frequencyToBin (float frequency) {
  ...
  Serial.println(int(frequency / binFrequency));
